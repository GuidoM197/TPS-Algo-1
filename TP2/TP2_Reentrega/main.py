    ...
    while True:
        ...
        if opcion == "1":
            ...
            while True:
                ...
                if not logica.validar_csv(guardado):
                    print("Porfavor que la extension del archivo sea .csv")
                    continue

                logica.opcion_1(datos, palabras, guardado)
                break
        ...
        if opcion == "2":
            ...
            while True:
                ...
                contacto = logica.validador_de_contacto(contacto, datos)
