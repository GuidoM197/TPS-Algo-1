...
class JuegoFlood:
    ...
    def cambiar_color(self, color):
        ...
        if self.pila_deshacer.esta_vacia():
            self.pila_deshacer.apilar(self.tablero_inicial)
        ...
        if verificar_existencia(copiar_pila(self.pila_deshacer), movimiento_actual):
            self.pila_rehacer = Pila()
    ...
    def deshacer(self):
        ...
        if self.pila_deshacer.ver_tope() == self.tablero_inicial:
            self.flood.grilla = self.pila_deshacer.ver_tope()
            self.pila_rehacer.apilar(self.pila_deshacer.desapilar())


        if not self.se_deshizo and not self.pila_deshacer.esta_vacia() and self.pila_deshacer.ver_tope() == self.pila_aux.ver_tope():
            self.pila_rehacer.apilar(self.pila_deshacer.desapilar())
            self.se_deshizo = True
    ...
    def rehacer(self):
        ...
        # if self.pila_rehacer.ver_tope() == self.pila_aux.ver_tope():
